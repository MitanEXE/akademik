            ...
            <ul>
                ...
                <li class="">
                    ...
                    <ul>
                        ...
                        @endif
                        @if (Auth::user()->job =="Siswa" && "Guru")
                        <li><a href="{{ route('users.akademik',Auth::user()->id)}}">Orang Tua / Wali</a></li>
                         <li><a href="{{ route('users.dataakademik',Auth::user()->id)}}">Akademik</a></li>
                        @endif
                    </ul>
                </li>
                @if (Auth::user()->job =="Admin" && "Admin")
                <li class="">
                    <a href="#">
