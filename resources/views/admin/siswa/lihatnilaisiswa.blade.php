                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_1" role="grid">
                                        <thead>
                                            ...
                                            : activate to sort column ascending" style="width: 300px;">Nama Mata Pelajaran</th>
                                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Edit
                                            : activate to sort column ascending" style="width: 20px;">Nilai</th>
                                            	<th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" aria-label="
                                                 Edit
                                            : activate to sort column ascending" style="width: 20px;">Keterangan</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($nilai as $nilai)
                                                ...
                                                <td class="sorting_1">{!! $nilai->kode_mapel !!}</td>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('assets/js/pages/table_lihatnilaisiswa.js') }}" ></script>
@stop
