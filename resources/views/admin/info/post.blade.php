            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-body">
                        <h3>{{ $post->title }}</h3>
                        <p>{{ $post->content }}</p>
                        <h8>*Peringatan untuk kolom keterangan cukup isikan saja dengan Hadir</h8>
                        <hr>
                        <h5>Keterangan</h5>
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ url('/comment') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="username" value="{{ Auth::user()->name }} ({{ Auth::user()->username }})" readonly="readonly">
