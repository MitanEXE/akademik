 jQuery(document).ready(function()
    {
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.get("sesi/delete/" + nodelete[0]  , function(data, status){
            });
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                if (nNew) {
                    ...
                    var nsesi = oTable.fnGetData(nRow);
                    var data = { sesi: nsesi[1]};
                    ...
                    //alert("Data sesi Berhasil Ditambah");
                    nNew = false;
                    setTimeout(
                        function() 
                        {
                    ...
                    var nsesi = oTable.fnGetData(nRow);
                    var data = { idsesi: nsesi[0], sesi: nsesi[1] };
