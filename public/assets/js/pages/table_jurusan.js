 jQuery(document).ready(function()
    {
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.get("jurusan/delete/" + nodelete[0]  , function(data, status){
            });
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                if (nNew) {
                    ...
                    var njurusan = oTable.fnGetData(nRow);
                    var data = { nama_jurusan: njurusan[1]};

                    $.ajax({
                        url: "jurusan/createjurusan",
                        type: "POST",
                    ...
                    var njurusan = oTable.fnGetData(nRow);
                    var data = { idjur: njurusan[0], nama_jurusan: njurusan[1] };

                    $.ajax({
                        url: "jurusan/editjurusan",
                        type: "POST",
                        data: JSON.stringify(data),
                        cache: false,
                        contentType: 'application/json; charset=utf-8',
