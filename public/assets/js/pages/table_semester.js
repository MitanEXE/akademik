 jQuery(document).ready(function()
    {
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.get("semester/delete/" + nodelete[0]  , function(data, status){
            });
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                if (nNew) {
                    ...
                    var nsemester = oTable.fnGetData(nRow);
                    var data = { semester: nsemester[1]};

                    $.ajax({
                        url: "semester/createsemester",
                        type: "POST",
                    ...
                    //alert("Data semester Berhasil Ditambah");
                    nNew = false;
                    setTimeout(
                        function() 
                        {
                    ...
                    var nsemester = oTable.fnGetData(nRow);
                    var data = { idkel: nsemester[0], semester: nsemester[1] };

                    $.ajax({
                        url: "semester/editsemester",
                        type: "POST",
                        data: JSON.stringify(data),
                        cache: false,
                        contentType: 'application/json; charset=utf-8',
