 jQuery(document).ready(function()
    {
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.get("tahunajaran/delete/" + nodelete[0]  , function(data, status){
            });
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                if (nNew) {
                    ...
                    var ntahun_ajaran = oTable.fnGetData(nRow);
                    var data = { tahun_ajaran: ntahun_ajaran[1]};

                    $.ajax({
                        url: "tahunajaran/createtahunajaran",
                        type: "POST",
                    ...
                    //alert("Data tahunajaran Berhasil Ditambah");
                    nNew = false;
                    setTimeout(
                        function() 
                        {
                    ...
                    var ntahun_ajaran = oTable.fnGetData(nRow);
                    var data = { id_tahun: ntahun_ajaran[0], tahun_ajaran: ntahun_ajaran[1] };

                    $.ajax({
                        url: "tahunajaran/edittahunajaran",
                        type: "POST",
                        data: JSON.stringify(data),
                        cache: false,
                        contentType: 'application/json; charset=utf-8',
