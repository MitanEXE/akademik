 jQuery(document).ready(function()
    {
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.get("blok/delete/" + nodelete[0]  , function(data, status){
            });
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                if (nNew) {
                    ...
                    var nblok = oTable.fnGetData(nRow);
                    var data = { blok: nblok[1]};
                    ...
                    //alert("Data blok Berhasil Ditambah");
                    nNew = false;
                    setTimeout(
                        function() 
                        {
                    ...
                    var nblok = oTable.fnGetData(nRow);
                    var data = { idblo: nblok[0], blok: nblok[1] };
